...
Specify the directory by setting the Backlight option in the device section of
`/etc/X11/xorg.conf.d/20-video.conf`.

For example, if the directory name is `intel_backlight` and you are using the
Intel driver:
